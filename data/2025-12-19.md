...
Recommendation: ★★☆☆☆ (32/100) - 与 Zotero 兴趣画像中的 lensing, dark matter 等主题/作者匹配。
...
### [2] [Decoupling perturbations from background in $f(Q)$ gravity: the square-root correction and the alleviation of the $σ_8$ tension](https://arxiv.org/abs/2512.16551)
...
### [3] [Uniform Rolling: An LSST Observing Cadence Offering Sufficient Survey Uniformity for Comprehensive Cosmological Analysis](https://arxiv.org/abs/2512.16478)
...
### [4] [Clustering redshift distribution calibration of weak lensing surveys using the DESI-DR1 spectroscopic dataset](https://arxiv.org/abs/2512.15963)
...
### [6] [Joint cosmological fits to DESI-DR1 full-shape clustering and weak gravitational lensing in configuration space](https://arxiv.org/abs/2512.15961)
...
### [7] [DESI-DR1 $3 \times 2$-pt analysis: consistent cosmology across weak lensing surveys](https://arxiv.org/abs/2512.15960)
...
### [8] [The AIDA-TNG project: abundance, radial distribution, and clustering properties of halos in alternative dark matter models](https://arxiv.org/abs/2512.15883)
...
### [9] [Dark Acoustic Oscillations as an Early-Universe Explanation of the DESI Anomaly](https://arxiv.org/abs/2512.15870)
...
### [10] [The AIDA-TNG project: dark matter profiles and concentrations in alternative dark matter models](https://arxiv.org/abs/2512.15869)
...
### [11] [The AIDA-TNG project: 3D halo shapes](https://arxiv.org/abs/2512.15856)
...
### [12] [The Simons Observatory: forecasted constraints on primordial gravitational waves with the expanded array of Small Aperture Telescopes](https://arxiv.org/abs/2512.15833)
...
### [16] [A faint M$_{\rm UV} = -14.5$ Lyman continuum leaker in the reionization epoch: unprecedented Ly$α$ properties at z=5.725](https://arxiv.org/abs/2512.16728)
...
### [17] [On the Origin of Kinematic Structure in the Young Association Serpens OB2](https://arxiv.org/abs/2512.16708)
...
### [18] [The high-redshift radio galaxy 3C 294 at low frequencies: radio detection of the X-ray Ghost](https://arxiv.org/abs/2512.16621)
...
### [19] [Unveiling the properties and origin of massive quenched galaxies at $z\ge2$ in the COLIBRE hydrodynamical simulations](https://arxiv.org/abs/2512.16208)
...
### [20] [LSTM-MDNz: Estimating Quasar Photometric Redshifts with an LSTM-Augmented Mixture Density Network](https://arxiv.org/abs/2512.16010)
*Jianzhen Chen,Zhijian Luo,Liping Fu,Zhu Chen,Hubing Xiao,Shaohua Zhang,Chenggang Shu*

Main category: astro-ph.GA

Recommendation: ★★☆☆☆ (25/100) - 与 Zotero 兴趣画像中的 euclid, csst 等主题/作者匹配。
...
### [23] [The Next Generation Fornax Survey (NGFS).VIII. A Support Vector Machine Approach for Disentangling Globular Clusters from other Sources](https://arxiv.org/abs/2512.15895)
...
### [24] [Cored galaxies in cuspy dark matter halos](https://arxiv.org/abs/2512.15886)
