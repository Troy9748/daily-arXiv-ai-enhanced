...
### [1] [Clustering with Light (but Massive) Relics](https://arxiv.org/abs/2512.14672)
...
### [2] [A sub-ppm upper limit on the cosmological variations of the fine structure constant alpha](https://arxiv.org/abs/2512.14441)
*S. Muller,A. Beelen,M. Guelin,J. H. Black,F. Combes,H. L. Bethlem,M. Gerin,C. Henkel,K. M. Menten,M. T. Murphy,W. Ubachs,N. Wozny*

Main category: astro-ph.CO

Recommendation: ★★☆☆☆ (25/100) - 与 Zotero 兴趣画像中的 alma, submillimeter 等主题/作者匹配。
...
### [3] [Catalogs of optically-selected clusters and photometric luminous red galaxies from the Hyper Suprime-Cam Subaru Strategic Program final year dataset](https://arxiv.org/abs/2512.13954)
...
### [4] [AtLAST -- Determination of Halo Mass Density Profiles at kpc Scales through Magnification Bias](https://arxiv.org/abs/2512.13895)
...
Recommendation: ★★☆☆☆ (25/100) - 与 Zotero 兴趣画像中的 alma, dusty 等主题/作者匹配。
...
### [7] [Buried but not destroyed: the evolution from prompt cusps to NFW haloes](https://arxiv.org/abs/2512.13804)
...
### [8] [Halo Lightcones with Optimised Orientation and Interpolation in Cosmological Simulations -- an application to mock H$α$ selected galaxies](https://arxiv.org/abs/2512.13801)
...
### [9] [Revealing the baryon cycle in Galaxy Clusters: connecting galaxy dynamics and gas thermodynamics using (sub-)mm-wave and optical IFU surveys](https://arxiv.org/abs/2512.14238)
...
### [10] [Bowshocks driven by the pole-on molecular jet of outbursting protostar SVS 13](https://arxiv.org/abs/2512.14458)
...
Recommendation: ★★☆☆☆ (36/100) - 与 Zotero 兴趣画像中的 molecular, alma, molecular gas 等主题/作者匹配。
...
### [11] [Investigating the Reionization Epoch through 21\,cm and Line Intensity Mapping Experiments](https://arxiv.org/abs/2512.13943)
*Anirban Roy,Anthony Pullen,Patrick C. Breysse,Rachel S. Somerville*

Main category: astro-ph.GA

Recommendation: ★★☆☆☆ (32/100) - 与 Zotero 兴趣画像中的 ska, dust, submillimeter, molecular 等主题/作者匹配。
...
### [12] [AtLAST -- A five fold increase in the number of identified Strongly Lensed Galaxies in the sub-millimetre and its consequences](https://arxiv.org/abs/2512.13896)
...
Recommendation: ★★☆☆☆ (32/100) - 与 Zotero 兴趣画像中的 lensing, dusty, submillimeter, herschel, dark matter 等主题/作者匹配。
...
### [13] [A first systematic study of [OIII] 88$μ$m at $z>8$: two luminous oxygen lines and a powerful ionized outflow in the first 600 million years](https://arxiv.org/abs/2512.14486)
...
Recommendation: ★★☆☆☆ (31/100) - 与 Zotero 兴趣画像中的 alma, jwst, dust 等主题/作者匹配。
...
### [14] [From ASTRID to BRAHMA -- The role of overmassive black holes in little red dots in cosmological simulations](https://arxiv.org/abs/2512.13957)
...
### [15] [Surveying Galaxy Clusters (in formation) in the Distant Universe](https://arxiv.org/abs/2512.14372)
...
Recommendation: ★★☆☆☆ (27/100) - 与 Zotero 兴趣画像中的 euclid, dust, submillimeter 等主题/作者匹配。
...
### [16] [Primordial Black Holes as Seeds for Extremely Overmassive AGN Observed by JWST](https://arxiv.org/abs/2512.14066)
...
### [17] [Local Group dwarf galaxies as dark matter probes](https://arxiv.org/abs/2512.13827)
*G. Battaglia,J. M. Arroyo Polonio,R. Pascale,M. Benito,R. Leaman,G. Thomas*

Main category: astro-ph.GA

Recommendation: ★★☆☆☆ (26/100) - 与 Zotero 兴趣画像中的 dark matter, dm halo 等主题/作者匹配。
...
### [18] [NGC 3521 as the Milky Way near twin: spectral energy distribution from UV to radio decameter ranges](https://arxiv.org/abs/2512.14664)
...
Recommendation: ★★☆☆☆ (25/100) - 与 Zotero 兴趣画像中的 herschel, dust 等主题/作者匹配。
...
### [19] [Cluster properties as a function of dynamical state in the DESI Legacy x UNIONS surveys](https://arxiv.org/abs/2512.14636)
...
### [20] [Connecting galaxies with their haloes -- from parsec to Mpc scales](https://arxiv.org/abs/2512.14281)
...
Recommendation: ★★☆☆☆ (25/100) - 与 Zotero 兴趣画像中的 molecular, dark matter 等主题/作者匹配。
...
### [21] [Exploring Cosmic Dawn with PANORAMIC II: Cosmic Variance and Galaxy Clustering at $z\sim10$](https://arxiv.org/abs/2512.14212)
...
### [22] [Can dwarf spheroidal galaxies host a central black hole ?](https://arxiv.org/abs/2512.14146)
*K. Aditya,A. Mangalam*
...
### [23] [The role of supernova remnants for the emergence of pre-biotic chemistry in molecular clouds](https://arxiv.org/abs/2512.14143)
...
Recommendation: ★★☆☆☆ (25/100) - 与 Zotero 兴趣画像中的 molecular 等主题/作者匹配。
...
### [24] [How is Cold Gas Loaded into Galactic Nuclear Outflows?](https://arxiv.org/abs/2512.14081)
*Yang Su,Xin Liu,Shiyu Zhang,Ji Yang,Yan Sun,Shaobo Zhang,Fujun Du,Xin Zhou,Qing-Zeng Yan,Xuepeng Chen*

Main category: astro-ph.GA

Recommendation: ★★☆☆☆ (25/100) - 与 Zotero 兴趣画像中的 dust, molecular 等主题/作者匹配。
...
### [25] [Cold Gas Infall onto A Brightest Group Galaxy via A Gas-Rich Minor Merger](https://arxiv.org/abs/2512.13932)
*Ming-Yang Zhuang,Jinyi Shangguan,Yuan Bian,Yue Shen,Luis C. Ho,Min Du,Junyao Li,Zhao-Yu Li,Jing Wang*

Main category: astro-ph.GA

Recommendation: ★★☆☆☆ (25/100) - 与 Zotero 兴趣画像中的 jwst, dust 等主题/作者匹配。
...
### [26] [Radio emission in star-forming galaxies: connection to restarted or relic AGN activity](https://arxiv.org/abs/2512.14646)
...
### [28] [Searching for Intermediate-Mass Black Holes in Milky Way satellites](https://arxiv.org/abs/2512.13823)
...
### [29] [Connection between galaxy morphology and dark-matter halo structure II: predicting disk structure from dark-matter halo properties](https://arxiv.org/abs/2512.13822)
