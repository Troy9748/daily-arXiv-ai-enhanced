...
### [1] [Modifying $Λ$CDM dynamics via out-of-equilibrium axions: reconciling SH0ES and DESI $H_0$ values](https://arxiv.org/abs/2606.09427)
...
### [2] [Optimising ultra-light dark matter searches with ground-based interferometers](https://arxiv.org/abs/2606.09210)
...
### [3] [Mock Catalogs of Strongly Lensed Gravitational Waves via a Halo Model Approach with Space-borne Detectors](https://arxiv.org/abs/2606.08899)
...
### [4] [Faraday Complexity and Depolarisation in a High-Rotation-Measure Radio Galaxy from the Spectra and Polarisation In Cutouts of Extragalactic Sources (SPICE-RACS) DR2](https://arxiv.org/abs/2606.07919)
*Debajyoti Mondal,Abhik Ghosh*

Main category: astro-ph.CO

Recommendation: ★★☆☆☆ (25/100) - 与 Zotero 兴趣画像中的 polarization 等主题/作者匹配。
...
### [5] [CMBolic: Symbolic emulators for the Cosmic Microwave Background. I. Lensing](https://arxiv.org/abs/2606.07745)
...
### [7] [XRISM Observations of Abell 1795: Evidence for Low Turbulence and Resonant Scattering](https://arxiv.org/abs/2606.08097)
...
### [8] [ALMA High-resolution Observation of the HH46/47 Outflow/disk/envelope System](https://arxiv.org/abs/2606.08607)
...
### [9] [Class I CH3OH Maser Emission from Bar-Driven Inflow Colliding with the Central Molecular Zone](https://arxiv.org/abs/2606.09425)
...
Recommendation: ★★☆☆☆ (36/100) - 与 Zotero 兴趣画像中的 molecular, herschel, dust 等主题/作者匹配。
...
Recommendation: ★★☆☆☆ (32/100) - 与 Zotero 兴趣画像中的 jwst, molecular 等主题/作者匹配。
...
### [11] [Euclid Quick Data Release (Q1): The impact of AGN emission on SED-derived physical properties](https://arxiv.org/abs/2606.07750)
...
Recommendation: ★★☆☆☆ (31/100) - 与 Zotero 兴趣画像中的 euclid 等主题/作者匹配。
...
### [12] [JWST Absorption-Line Analysis of UV-Bright Galaxies at $z=7.2-10.6$: Early Chemical Enrichment Traced by C, O, Mg, Al, Si, and Fe](https://arxiv.org/abs/2606.08782)
...
### [13] [Satellite compaction pathways: environmental drivers shaping dwarf galaxy corpulence in the TNG50 simulation](https://arxiv.org/abs/2606.09817)
...
### [14] [A Scaling Relation of LRDs between Broad H$α$ and Bolometric Luminosities: Enhanced Broad H$α$ Emission Relative to Low-$z$ Type 1 AGN](https://arxiv.org/abs/2606.09726)
...
### [15] [NEXUS: Abundance, Environments, and Spectral Diversity of Little Red Dots from the NIRSpec MSA Sample](https://arxiv.org/abs/2606.09721)
...
### [16] [A differentiable forward model for weakly perturbed stellar streams: substructure forecasts from density and kinematics spectra](https://arxiv.org/abs/2606.09629)
*Noemi Anau Montel,Fabian Schmidt*

Main category: astro-ph.GA

Recommendation: ★★☆☆☆ (25/100) - 与 Zotero 兴趣画像中的 lensing, strong lensing, dark matter 等主题/作者匹配。
...
### [17] [Blowing star formation away in AGN hosts (BAH) -- V: The Feeding-Feedback Cycle in local AGNs as reveled by their stellar populations](https://arxiv.org/abs/2606.09616)
...
### [18] [Characterizing Stellar Streams with Error-Aware Machine Learning](https://arxiv.org/abs/2606.09576)
...
### [19] [Towards a consistent framework of determining active galactic nucleus contribution fraction and host galaxy properties](https://arxiv.org/abs/2606.09413)
...
### [20] [From filaments to clumps: filament properties with synthetic Herschel observations](https://arxiv.org/abs/2606.08778)
...
### [21] [Star Formation Drives Production of Low Energy Cosmic Rays](https://arxiv.org/abs/2606.09651)
...
### [23] [A Unified Ionization Framework for the Spectroscopic Diversity of Tidal Disruption Events](https://arxiv.org/abs/2606.09325)
...
### [25] [Rapid intermediate-mass black hole formation via runaway mergers of black holes](https://arxiv.org/abs/2606.08961)
...
### [26] [Clumps in a Cocoon: Geometry and Mixing Set the Universal X-ray to H$α$ Surface Brightness Ratio](https://arxiv.org/abs/2606.07741)
