...
### [1] [Probing Collapsed Dark Matter Halos with Fast Radio Bursts](https://arxiv.org/abs/2604.12189)
*Yuxuan He,Weiyang Wang,Chen Zhang,Yi-Ming Zhong*

Main category: astro-ph.CO

Recommendation: ★★★★☆ (80/100) - 与 Zotero 兴趣画像中的 dark matter, lensing, strong lensing, lens model 等主题/作者匹配。
...
### [2] [Probing Scalar-Tensor-Induced Gravitational Waves in the nHz Band: $\texttt{NANOGrav}$ and SKA](https://arxiv.org/abs/2604.13012)
*William Iania,Angelo Ricciardone*

Main category: astro-ph.CO

Recommendation: ★★★★☆ (74/100) - 与 Zotero 兴趣画像中的 ska 等主题/作者匹配。
...
### [3] [Model-Independent Analysis of Type Ia Supernova Datasets and Implications for Dark Energy](https://arxiv.org/abs/2604.11883)
...
Recommendation: ★★★☆☆ (54/100) - 与 Zotero 兴趣画像中的 dark matter, jwst 等主题/作者匹配。
...
### [5] [Revisiting the angular size-redshift cosmological test with milliarcsecond radio structures in active galactic nuclei](https://arxiv.org/abs/2604.12936)
...
### [6] [Constraints on Coupled Dark Energy in the DESI Era](https://arxiv.org/abs/2604.12032)
...
### [8] [JWST Observations of Starbursts: Dust Processing in the M82 Superwind](https://arxiv.org/abs/2604.11873)
...
### [9] [A Post-starburst Galaxy Undergoing Ram-pressure Stripping at Redshift 3.06](https://arxiv.org/abs/2604.11892)
...
### [10] [Obscured at the Core: Evidence for Nuclear Dust in Reddened Type-1 AGN](https://arxiv.org/abs/2604.13031)
...
### [11] [How I Wonder What You Are -- JWST's Little Red Dots do not TWINKLE](https://arxiv.org/abs/2604.13000)
...
### [12] [JWST observations of photodissociation regions. IV. Carbonaceous emission band sub-components in NGC 7023 have distinct spatial distributions](https://arxiv.org/abs/2604.12860)
...
### [13] [A Forward, Analytic, Differentiable, Geometric (But Inflexible) Lens Model](https://arxiv.org/abs/2604.11908)
*Paul L. Schechter*

Main category: astro-ph.GA

Recommendation: ★★★★☆ (73/100) - 与 Zotero 兴趣画像中的 lens model, euclid 等主题/作者匹配。
...
### [14] [Dark Matter's influence on Evolution of MBHB in Dwarf Galaxies: A Case Study of Leo I dSph](https://arxiv.org/abs/2604.12658)
...
### [15] [Consistency of the dark matter halo perturbation parameter from morphological and kinematic lopsidedness of galaxies](https://arxiv.org/abs/2604.11886)
...
### [16] [M1-92: AGB interruption and isotopic ratio paradox. Chemistry and morpho-kinematics from improved shapemol modelling](https://arxiv.org/abs/2604.12569)
...
### [17] [Metal enrichment in the galaxy group IC 1262](https://arxiv.org/abs/2604.12608)
...
### [18] [Reconstructing chemical enrichment pathways in disc galaxies: A phylogenetic approach](https://arxiv.org/abs/2604.11974)
...
### [19] [Introducing $ΔV_{\star-g}$: a new universal kinematic disturbance parameter](https://arxiv.org/abs/2604.11905)
