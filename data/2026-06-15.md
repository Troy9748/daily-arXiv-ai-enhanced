...
Recommendation: ★★☆☆☆ (25/100) - 与 Zotero 兴趣画像中的 dark matter, ska 等主题/作者匹配。
...
### [5] [Constraints on Stable Scalar-Tensor Dark Energy from DESI Data and Solar System Tests](https://arxiv.org/abs/2606.14014)
...
### [8] [Identifying Warped Galaxies in Pan-STARRS and Euclid using Deep Convolutional Neural Network](https://arxiv.org/abs/2606.14152)
*Saranya Suguna,Arunima Banerjee*

Main category: astro-ph.GA

Recommendation: ★★☆☆☆ (27/100) - 与 Zotero 兴趣画像中的 euclid 等主题/作者匹配。
...
### [9] [GA-NIFS: The interplay between feedback and star formation at 3 < z < 9 probed by JWST/NIRSpec IFU](https://arxiv.org/abs/2606.13819)
...
### [10] [CANUCS/Technicolor Data Release 2: A Catalogue of Galaxy Structural Parameters in up to 29 HST+JWST bands and a Multi-Wavelength Exploration of the Galaxy Size-Mass Relation at $0.6 < z \leq 4$](https://arxiv.org/abs/2606.13781)
...
### [11] [From THESAN-ZOOM to JWST: Predicting ionizing photon escape and the rise of UV-bright reionization sources](https://arxiv.org/abs/2606.14671)
...
### [12] [A new CIGALE module for modeling AGN emission lines](https://arxiv.org/abs/2606.14643)
...
### [13] [Uncovering DM distribution by combining stellar kinematics and integrated HI spectra: method validation](https://arxiv.org/abs/2606.14271)
...
### [15] [Lensed hot stars with HST in the 2030s](https://arxiv.org/abs/2606.14392)
*J. M. Diego*
...
### [16] [The S-PLUS Fornax Project (S+FP): Fornax-like clusters in cosmological hydrodynamical simulations](https://arxiv.org/abs/2606.14109)
...
### [17] [A novel data-driven approach to extract stellar population properties from galaxy spectra using absorption indices](https://arxiv.org/abs/2606.13791)
...
### [18] [Reconstructing the orbits of Milky Way dwarf galaxies: An LMC perspective](https://arxiv.org/abs/2606.13787)
...
### [20] [Turbulence in the multi-phase circumgalactic medium: bridging TNG50 and idealized kpc-scale simulations](https://arxiv.org/abs/2606.13777)
