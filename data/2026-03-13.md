...
### [1] [Comparing the $M_{gas}-N_{yso}$ Relation inside a Giant Molecular Cloud](https://arxiv.org/abs/2603.12212)
...
Recommendation: ★★★★★ (81/100) - 与 Zotero 兴趣画像中的 molecular, herschel, molecular gas 等主题/作者匹配。
...
### [2] [JWST's PEARLS: A clumpy ring galaxy at $z = 4.0148$](https://arxiv.org/abs/2603.11575)
...
Recommendation: ★★★★★ (81/100) - 与 Zotero 兴趣画像中的 jwst, lensing, strong lensing 等主题/作者匹配。
...
Recommendation: ★★★★☆ (78/100) - 与 Zotero 兴趣画像中的 dust, euclid 等主题/作者匹配。
...
### [4] [The TRGB-SBF Project. IV. A Color Calibration of the TRGB in the JWST F090W+F150W Filters](https://arxiv.org/abs/2603.11160)
...
### [5] [Balmer Decrements and Nebular-Stellar Reddening in JADES Galaxies at $2.7<z<7$](https://arxiv.org/abs/2603.11338)
...
### [6] [Large-scale environments of star-forming active galactic nuclei: How black hole mass, accretion rate, and luminosity connect to dark matter halos](https://arxiv.org/abs/2603.11169)
...
### [7] [BLUEPRINT: Blue-dominant Lyman-alpha (Ly$α$) emission as an evidence of gas inflow in ultra-low-mass galaxies at z = 3](https://arxiv.org/abs/2603.11411)
...
### [8] [AstroSat-UVIT observations of a possibly interacting pair of galaxies in HCG 77](https://arxiv.org/abs/2603.12173)
...
### [9] [\HI 21-cm Line Properties of the Nearby LIRG IRAS 04296+2923](https://arxiv.org/abs/2603.11899)
...
### [10] [GSE vs. LMC: reshaping of radially biased stellar haloes by satellites](https://arxiv.org/abs/2603.11159)
...
### [12] [Chemical radial gradients for the bulge-bar stellar populations from the APOGEE survey](https://arxiv.org/abs/2603.12070)
...
### [13] [Origin of open clusters revealed by the evolution of the m_max$-$M_ecl relation](https://arxiv.org/abs/2603.11782)
...
### [15] [The impact of baryons on weak lensing statistics as a function of halo mass and radius](https://arxiv.org/abs/2603.11815)
*Max E. Lee,Zoltan Haiman,Shy Genel*

Main category: astro-ph.CO

Recommendation: ★★★★★ (81/100) - 与 Zotero 兴趣画像中的 lensing, euclid, dark matter 等主题/作者匹配。
...
### [16] [Gravitational Lensing Effects by Galaxy Clusters on Ionised Bubble Size Distribution during the Epoch of Reionisation](https://arxiv.org/abs/2603.11371)
*Di Wu,Nan Li,Huanyuan Shan,Zhenghao Zhu*

Main category: astro-ph.CO

Recommendation: ★★★★☆ (78/100) - 与 Zotero 兴趣画像中的 lensing, ska 等主题/作者匹配。
...
### [17] [Cosmological gravity on all scales V: MCMC forecasts combining large scale structure and CMB lensing for binned phenomenological modified gravity](https://arxiv.org/abs/2603.11895)
...
Recommendation: ★★★★☆ (67/100) - 与 Zotero 兴趣画像中的 euclid, lensing 等主题/作者匹配。
