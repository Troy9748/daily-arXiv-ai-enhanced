...
### [1] [Transient protostellar cores in high mass star forming regions revealed by time-resolved synthetic imaging of dust emission](https://arxiv.org/abs/2512.09998)
...
Recommendation: ★★☆☆☆ (36/100) - 与 Zotero 兴趣画像中的 dust, alma, molecular 等主题/作者匹配。
...
### [2] [Resolving the ionizing photon budget crisis with JWST/NIRCam HII clumping constraints at z=6](https://arxiv.org/abs/2512.10839)
...
### [3] [Tracking Protostellar Variability in Massive Protoclusters with ALMA: I. Insights from QUARKS and MaMMOtH](https://arxiv.org/abs/2512.10298)
...
Recommendation: ★★☆☆☆ (32/100) - 与 Zotero 兴趣画像中的 alma, submillimeter 等主题/作者匹配。
...
### [4] [Signatures of star formation inside galactic outflows](https://arxiv.org/abs/2512.10924)
...
### [5] [Weighing the Milky Way's Satellite Galaxies Using Pulsar Accelerations](https://arxiv.org/abs/2512.10883)
...
### [6] [A remarkable Gaia-assisted discovery of a temporally varying, triple-lensed quasar at z=2.67](https://arxiv.org/abs/2512.10811)
...
### [7] [Pressure and Star Formation in LITTLE THINGS Dwarf Irregular Galaxies](https://arxiv.org/abs/2512.10776)
...
### [8] [$^{12}$CO $J$=3--2 Observations of Tycho's supernova remnant: constraints on the environmental gas properties](https://arxiv.org/abs/2512.10245)
...
### [9] [Deuterium fractionation and CO depletion in Barnard 5](https://arxiv.org/abs/2512.10143)
...
### [11] [KURVS: chemical properties from multiple strong line calibrations for star-forming galaxies at $z\sim1.5$](https://arxiv.org/abs/2512.09983)
...
### [12] [OutLines: Modeling Spectral Lines from Winds, Bubbles, and Outflows](https://arxiv.org/abs/2512.10650)
*Sophia R. Flury*
...
### [14] [The Narrow Emission Lines of Seyfert 1 Galaxies: Comparisons with a Large SDSS Sample](https://arxiv.org/abs/2512.10186)
...
### [15] [Strong Bars, Strong Inflow: The Effect of Bar Strength on Gas Inflow](https://arxiv.org/abs/2512.10164)
...
### [16] [Model independent approach towards measuring expansion and growth factor from next generation galaxy clustering and lensing angular power spectrum](https://arxiv.org/abs/2512.10742)
*Ziad Sakr*

Main category: astro-ph.CO

Recommendation: ★★☆☆☆ (39/100) - 与 Zotero 兴趣画像中的 lensing, ska, euclid 等主题/作者匹配。
...
### [17] [Inflation in light of ACT/SPT: a new perspective from Weyl gravity](https://arxiv.org/abs/2512.10862)
*Qing-Yang Wang*
...
### [18] [Evidence of galaxy cluster rotation in the cosmic microwave background](https://arxiv.org/abs/2512.10951)
...
### [19] [Updated and Projected Cosmic Microwave Background Bounds on WIMP Annihilation](https://arxiv.org/abs/2512.10896)
*Charlotte Myers,Dominic Agius,Daniele Gaggero,Angelo Ricciardone*

Main category: astro-ph.CO

Recommendation: ★★☆☆☆ (25/100) - 与 Zotero 兴趣画像中的 lensing, polarization, dark matter 等主题/作者匹配。
...
### [20] [On the validity of the continuity equation in a modified gravity framework with CMB, DES 3x2pt and tomographic ISW data](https://arxiv.org/abs/2512.10802)
...
### [21] [Improved Identification of Strongly Lensed Gravitational Waves with Host Galaxy Locations](https://arxiv.org/abs/2512.10344)
*Tonghua Liu,Kai Liao*

Main category: astro-ph.CO

Recommendation: ★★☆☆☆ (25/100) - 与 Zotero 兴趣画像中的 lensing, euclid 等主题/作者匹配。
...
### [22] [UV Luminosity Functions from HST and JWST: A Possible Resolution to the High-Redshift Galaxy Abundance Puzzle and Implications for Cosmic Strings](https://arxiv.org/abs/2512.09980)
