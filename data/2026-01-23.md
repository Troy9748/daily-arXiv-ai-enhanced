...
### [1] [Multi-band Reconstruction of Sixteen Gravitational Lens Systems using PISCO data](https://arxiv.org/abs/2601.15585)
...
Recommendation: ★★★★☆ (80/100) - 与 Zotero 兴趣画像中的 euclid, csst, lensing, strong lensing 等主题/作者匹配。
...
### [2] [JWST Advanced Deep Extragalactic Survey (JADES) Data Release 5: MIRI Coordinated Parallels in GOODS-S and GOODS-N](https://arxiv.org/abs/2601.15955)
...
Recommendation: ★★★★☆ (78/100) - 与 Zotero 兴趣画像中的 jwst, dusty 等主题/作者匹配。
...
### [3] [Hierarchical bayesian inference: constraining population distribution of dark matter halo shapes via stellar streams](https://arxiv.org/abs/2601.15373)
*David Chemaly,Elisabeth Sola,Vasily Belokurov,Sergey Kosposov,GyuChul Meyong,HanYuan Zhang,Denis Erkal*

Main category: astro-ph.GA

Recommendation: ★★★★☆ (77/100) - 与 Zotero 兴趣画像中的 dark matter, euclid 等主题/作者匹配。
...
### [4] [JWST Advanced Deep Extragalactic Survey (JADES) Data Release 5: Catalogs of inferred morphological properties of galaxies from JWST/NIRCam imaging in GOODS-N and GOODS-S](https://arxiv.org/abs/2601.15957)
...
### [5] [JWST Advanced Deep Extragalactic Survey (JADES) Data Release 5: Photometric Catalog](https://arxiv.org/abs/2601.15956)
...
### [6] [JWST Advanced Deep Extragalactic Survey (JADES) Data Release 5: NIRCam Imaging in GOODS-S and GOODS-N](https://arxiv.org/abs/2601.15954)
...
### [7] [JWST Advanced Deep Extragalactic Survey (JADES) Data Release 5: Photometrically Selected Galaxy Candidates at z > 8](https://arxiv.org/abs/2601.15959)
...
Recommendation: ★★★★☆ (69/100) - 与 Zotero 兴趣画像中的 jwst 等主题/作者匹配。
...
### [8] [Clump-like Structures in High-Redshift Galaxies: Mass Scaling and Radial Trends from JADES](https://arxiv.org/abs/2601.15965)
...
### [10] [A Stratification in Magnetic Field Structures: The Radio Outflow in NGC 4151](https://arxiv.org/abs/2601.15382)
*Salmoli Ghosh,P. Kharb,E. Costantini,J. Gallimore,D. Williams-Baldwin,M. Mehdipour*

Main category: astro-ph.GA

Recommendation: ★★★☆☆ (60/100) - 与 Zotero 兴趣画像中的 polarization, polarized 等主题/作者匹配。
...
### [11] [Spatially resolved stellar-to-total dynamical mass relation: Radial variations, gradients and profiles of galaxy stellar populations](https://arxiv.org/abs/2601.16019)
*L. Scholz-Diaz,A. R. Gallazzi,S. Zibetti,D. Mattolini*

Main category: astro-ph.GA

Recommendation: ★★★☆☆ (58/100) - 与 Zotero 兴趣画像中的 dust, dark matter 等主题/作者匹配。
...
### [12] [JADES: Evolution of nitrogen abundances in star-forming galaxies from z ~ 1.5-7](https://arxiv.org/abs/2601.15964)
...
### [14] [An Analysis of AGN Feedback in the Compact Galaxy Group Stephan's Quintet](https://arxiv.org/abs/2601.15384)
...
### [16] [What factors shape the radio luminosity of star-forming galaxies? A new calibration from LoTSS-DR2](https://arxiv.org/abs/2601.15374)
...
### [19] [Intrinsic alignments in the FLAMINGO simulations with two-point statistics](https://arxiv.org/abs/2601.15851)
...
### [22] [Two Fluid Quantum Bouncing Cosmology I: Theoretical Model](https://arxiv.org/abs/2601.15542)
