...
### [1] [\textit{Euclid} preparation. Baryon acoustic oscillations extraction techniques: comparison and optimisation](https://arxiv.org/abs/2605.03446)
...
### [2] [New constraints on primordial non-Gaussianity from large-scale cross-correlations of CMB lensing and the cosmic infrared background](https://arxiv.org/abs/2605.03783)
*Joseph Thornton,Fiona McCarthy,Carmen Embil Villagra,Blake D. Sherwin*

Main category: astro-ph.CO

Recommendation: ★★☆☆☆ (29/100) - 与 Zotero 兴趣画像中的 lensing, dust 等主题/作者匹配。
...
### [3] [Thermal activation rate of dilute axion stars close to the maximum mass](https://arxiv.org/abs/2605.03771)
...
### [4] [The Keplerian disk, envelope, and streamers surrounding an early O-type protostar in the Sagittarius C cloud of the Central Molecular Zone](https://arxiv.org/abs/2605.03883)
...
Recommendation: ★★☆☆☆ (32/100) - 与 Zotero 兴趣画像中的 jwst, molecular, molecular gas 等主题/作者匹配。
...
### [6] [Environmental Quenching of High-Redshift Galaxies: Interpreting JWST Observations with Simulations](https://arxiv.org/abs/2605.03008)
...
### [8] [The Computed Microwave Spectrum of the Protonated Fullerene C60H+](https://arxiv.org/abs/2605.04015)
...
### [9] [Not So Isolated: Green Pea Galaxies in Overdense Environments revealed by VLT/MUSE](https://arxiv.org/abs/2605.03676)
...
### [10] [The Significant Role of Hydrogen in the Formation of Silicon Carbide in Evolved Stars](https://arxiv.org/abs/2605.03575)
...
### [11] [Systematic underestimation of polarisation angle dispersion and its consequences for magnetic field strength estimates in star-forming regions](https://arxiv.org/abs/2605.03507)
...
### [13] [Microlensing time-scales and flux magnification probabilities of a sample of 204 lensed quasars](https://arxiv.org/abs/2605.03905)
...
### [15] [Peering down the barrel with DESI DR2: 10 000+ inflows at $z$ < 0.6 reveal how galaxies accrete cold gas](https://arxiv.org/abs/2605.02999)
...
### [16] [Built to Rest: The Evolving Star-Forming Main Sequence Requires Episodic Quiescence or Late Assembly](https://arxiv.org/abs/2605.02997)
