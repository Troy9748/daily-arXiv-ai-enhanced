...
### [1] [ALMA High-resolution Observation of the HH46/47 Outflow/disk/envelope System](https://arxiv.org/abs/2606.08607)
...
Recommendation: ★★★★★ (81/100) - 与 Zotero 兴趣画像中的 molecular, herschel, dust 等主题/作者匹配。
...
### [3] [Mapping Interstellar Ice Inventory toward Class 0 Protostars in Star-forming Region Orion A with JWST Data](https://arxiv.org/abs/2606.09776)
...
### [4] [Euclid Quick Data Release (Q1): The impact of AGN emission on SED-derived physical properties](https://arxiv.org/abs/2606.07750)
...
Recommendation: ★★★★☆ (77/100) - 与 Zotero 兴趣画像中的 euclid 等主题/作者匹配。
...
### [5] [JWST Absorption-Line Analysis of UV-Bright Galaxies at $z=7.2-10.6$: Early Chemical Enrichment Traced by C, O, Mg, Al, Si, and Fe](https://arxiv.org/abs/2606.08782)
...
### [6] [From filaments to clumps: filament properties with synthetic Herschel observations](https://arxiv.org/abs/2606.08778)
*Zhen-Xing Ma,Zu-Jia Lu*

Main category: astro-ph.GA

Recommendation: ★★★★☆ (69/100) - 与 Zotero 兴趣画像中的 herschel 等主题/作者匹配。
...
### [7] [A differentiable forward model for weakly perturbed stellar streams: substructure forecasts from density and kinematics spectra](https://arxiv.org/abs/2606.09629)
*Noemi Anau Montel,Fabian Schmidt*

Main category: astro-ph.GA

Recommendation: ★★★★☆ (67/100) - 与 Zotero 兴趣画像中的 lensing, strong lensing, dark matter 等主题/作者匹配。
...
### [8] [A Scaling Relation of LRDs between Broad H$α$ and Bolometric Luminosities: Enhanced Broad H$α$ Emission Relative to Low-$z$ Type 1 AGN](https://arxiv.org/abs/2606.09726)
...
### [9] [Towards a consistent framework of determining active galactic nucleus contribution fraction and host galaxy properties](https://arxiv.org/abs/2606.09413)
...
### [12] [NEXUS: Abundance, Environments, and Spectral Diversity of Little Red Dots from the NIRSpec MSA Sample](https://arxiv.org/abs/2606.09721)
...
### [13] [Characterizing Stellar Streams with Error-Aware Machine Learning](https://arxiv.org/abs/2606.09576)
...
### [14] [Star Formation Drives Production of Low Energy Cosmic Rays](https://arxiv.org/abs/2606.09651)
...
### [15] [TYC 170-1218-1: A new r-process-enhanced extremely metal-poor star, rich in Th](https://arxiv.org/abs/2606.09352)
...
### [16] [A Unified Ionization Framework for the Spectroscopic Diversity of Tidal Disruption Events](https://arxiv.org/abs/2606.09325)
...
### [17] [The complex kinematics of the young stars orbiting the supermassive black hole in the Galactic center can be explained by the presence of an intermediate mass companion of Sgr A$^\star$](https://arxiv.org/abs/2606.08971)
...
### [18] [Rapid intermediate-mass black hole formation via runaway mergers of black holes](https://arxiv.org/abs/2606.08961)
...
### [19] [Clumps in a Cocoon: Geometry and Mixing Set the Universal X-ray to H$α$ Surface Brightness Ratio](https://arxiv.org/abs/2606.07741)
...
### [23] [Faraday Complexity and Depolarisation in a High-Rotation-Measure Radio Galaxy from the Spectra and Polarisation In Cutouts of Extragalactic Sources (SPICE-RACS) DR2](https://arxiv.org/abs/2606.07919)
...
### [24] [Modifying $Λ$CDM dynamics via out-of-equilibrium axions: reconciling SH0ES and DESI $H_0$ values](https://arxiv.org/abs/2606.09427)
...
### [25] [Reconciling large-scale Lyman-$α$ correlations with the SCRIPT Semi-numerical Model](https://arxiv.org/abs/2606.08368)
...
### [26] [XRISM Observations of Abell 1795: Evidence for Low Turbulence and Resonant Scattering](https://arxiv.org/abs/2606.08097)
