...
Recommendation: ★★☆☆☆ (35/100) - 与 Zotero 兴趣画像中的 dark matter, lensing, strong lensing, lens model 等主题/作者匹配。
...
### [3] [Revisiting the angular size-redshift cosmological test with milliarcsecond radio structures in active galactic nuclei](https://arxiv.org/abs/2604.12936)
...
### [5] [Beyond the Standard Model of Cosmology: Testing new paradigms with a Multiprobe Exploration of the Dark Universe](https://arxiv.org/abs/2604.12020)
*Juan Garcia-Bellido*

Main category: astro-ph.CO

Recommendation: ★★☆☆☆ (25/100) - 与 Zotero 兴趣画像中的 dark matter, jwst 等主题/作者匹配。
...
### [6] [Model-Independent Analysis of Type Ia Supernova Datasets and Implications for Dark Energy](https://arxiv.org/abs/2604.11883)
...
Recommendation: ★★☆☆☆ (27/100) - 与 Zotero 兴趣画像中的 lens model, euclid 等主题/作者匹配。
...
### [15] [M1-92: AGB interruption and isotopic ratio paradox. Chemistry and morpho-kinematics from improved shapemol modelling](https://arxiv.org/abs/2604.12569)
...
### [16] [Consistency of the dark matter halo perturbation parameter from morphological and kinematic lopsidedness of galaxies](https://arxiv.org/abs/2604.11886)
