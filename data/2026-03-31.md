...
### [2] [Cosmic Shear in Effective Field Theory at Two-Loop Order: Revisiting $S_8$ in Dark Energy Survey Data](https://arxiv.org/abs/2603.28761)
...
### [6] [A Black Hole Star at Cosmic Noon: Extreme Balmer break, photospheric continuum, and broad absorption by thick winds in a Little Red Dot at z=1.7](https://arxiv.org/abs/2603.28335)
...
Recommendation: ★★★★☆ (72/100) - 与 Zotero 兴趣画像中的 jwst, euclid 等主题/作者匹配。
...
### [8] [Star Formation Beyond the Optical Disk : The Low-Density Outskirts of NGC2090](https://arxiv.org/abs/2603.28395)
...
### [9] [Catching the Nebular Needle in a Polluted Haystack: Line-emission Signatures from Population III-forming Pockets around Massive Galaxies at the End of Reionization](https://arxiv.org/abs/2603.27582)
...
### [10] [The complex relationships between AGN, bars and bulges](https://arxiv.org/abs/2603.28208)
...
### [11] [A Wide and Deep Exploration of Radio-detected Active Galactic Nuclei with Subaru HSC (WERGS). XIII. High-Redshift Radio Quasar candidates beyond Ultra-Steep Spectrum Selection: Dropout selection from HSC--VLASS over $\sim$1200 deg$^2$](https://arxiv.org/abs/2603.28044)
...
### [14] [Great Balls of Fire: Star Formation in Gas Clouds Accelerated by a Hot Wind](https://arxiv.org/abs/2603.26899)
...
### [15] [The ASKAP-FLASH survey: A first look at the multiwavelength properties and redshift distribution of compact radio sources](https://arxiv.org/abs/2603.26878)
...
### [16] [A cosmological framework for stellar collisions at high redshift in proto-globular clusters, nuclear star clusters, and Little Red Dots](https://arxiv.org/abs/2603.26872)
