...
### [1] [Effective Magnetic Susceptibility of Dust Grains with Superparamagnetic Inclusions and Implications](https://arxiv.org/abs/2602.14101)
*Thiem Hoang*

Main category: astro-ph.GA

Recommendation: ★★★★☆ (75/100) - 与 Zotero 兴趣画像中的 dust, polarization 等主题/作者匹配。
...
### [2] [Dense Molecular Clumps with Large Blue Asymmetries: Evidence for Collapse](https://arxiv.org/abs/2602.13992)
...
### [3] [Modelling the non-equilibrium chemistry of the Milky Way's cold nuclear wind](https://arxiv.org/abs/2602.13580)
...
### [4] [New Dynamical Measurements from a Lensed Quasar Sample: Joint Analysis Constrains the Mass Profile Evolution of Lens Galaxies](https://arxiv.org/abs/2602.13578)
*Ziyu Guo,Yun Chen,Yiping Shu,Jiaze Gao,Hui Li,Zizhao He,Jun Wang*

Main category: astro-ph.GA

Recommendation: ★★★☆☆ (58/100) - 与 Zotero 兴趣画像中的 lensing, strong lensing 等主题/作者匹配。
...
### [5] [MeerKAT discovery of a high-redshift strongly-lensed hydroxyl gigamaser](https://arxiv.org/abs/2602.13396)
...
### [6] [Characterizing Lyman alpha emission from high-redshift galaxies](https://arxiv.org/abs/2602.13389)
...
### [7] [Surveying the Giant HII Regions of the Milky Way with SOFIA: VIII. W43 Main](https://arxiv.org/abs/2602.13470)
...
### [9] [Modeling Globular Cluster Stellar Streams with a Basis-Expansion N-body Code](https://arxiv.org/abs/2602.13385)
...
### [10] [Large-scale and local environmental drivers of quenching: tracing H$α$ concentration in X-ray and optical galaxy groups](https://arxiv.org/abs/2602.14628)
...
### [11] [ARCHITECTS II: Impact of subgrid physics on the observable properties of the circumgalactic medium](https://arxiv.org/abs/2602.13394)
...
### [12] [Ultramassive Black Holes and the Three $M$-$σ$ Relations](https://arxiv.org/abs/2602.13382)
*Andrew King*
...
### [13] [VENUS: Strong-lensing model of MACS J1931.8-2635 -- revealing the farthest multiply imaged supernova](https://arxiv.org/abs/2602.14074)
...
Recommendation: ★★★★★ (81/100) - 与 Zotero 兴趣画像中的 lensing, jwst, lens model 等主题/作者匹配。
...
### [14] [Constraining Lorentz Violation using 21cm and CMB Cross Correlations](https://arxiv.org/abs/2602.14052)
*Bhuwan Joshi,Rahul Kothari,Shyam Chaudhary*

Main category: astro-ph.CO

Recommendation: ★★★★☆ (67/100) - 与 Zotero 兴趣画像中的 ska, polarization 等主题/作者匹配。
...
### [16] [Exploring Non-minimal coupling using ultra-diffuse galaxies](https://arxiv.org/abs/2602.14747)
...
### [17] [Gravitational Wave Echoes of the First Order Phase Transition in a Kination-Induced Big Bang](https://arxiv.org/abs/2602.15023)
...
### [18] [The Signature of Strong High-Redshift Radio Backgrounds on the Cosmic Dawn 21-cm Bispectrum](https://arxiv.org/abs/2602.13445)
