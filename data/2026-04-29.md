...
### [1] [Environmental dependence of the Mass-Metallicity Star Formation Relations at z=4-10 with JWST](https://arxiv.org/abs/2604.25632)
...
Recommendation: ★★★★★ (81/100) - 与 Zotero 兴趣画像中的 jwst, alma, euclid 等主题/作者匹配。
...
### [2] [The PHANGS-Hα survey. Ground-based narrow-band imaging of nearby star-forming galaxies](https://arxiv.org/abs/2604.25627)
...
Recommendation: ★★★★☆ (80/100) - 与 Zotero 兴趣画像中的 alma, jwst, molecular, molecular gas 等主题/作者匹配。
...
### [3] [Multi-component, axisymmetric dynamical models of dSphs based on distribution functions: inferences on dark matter and intermediate-mass black holes in Draco and Ursa Minor](https://arxiv.org/abs/2604.24855)
...
### [4] [From short-lived to long-lived clouds: impact of star formation models on giant molecular cloud evolution in simulations of an NGC 300-like galaxy](https://arxiv.org/abs/2604.25911)
...
### [5] [JOYS+ analyses of OCN$^-$, N$_2$O, NO, and complex cyanides in ices -- Thermal processing results in modest enhancement of OCN$^-$ ice](https://arxiv.org/abs/2604.25915)
...
### [6] [Compton-thick AGN Characterisation in a Multi-wavelength Context: Insights from the 70-Month \textit{SWIFT}/BAT Catalogue](https://arxiv.org/abs/2604.25543)
...
### [7] [Galaxy mergers and disk angular momentum evolution: stellar halos as a critical test](https://arxiv.org/abs/2604.24965)
...
### [8] [Galactic tides and the outer density profile of the Sculptor and Ursa Minor dwarf spheroidals](https://arxiv.org/abs/2604.24853)
...
### [9] [Spectral Evolution and Transient Broad-Line Features in the Isolated AGN UNAM-KIAS 613](https://arxiv.org/abs/2604.25219)
...
### [11] [The Thermodynamic and Kinematic Evolution of Circumgalactic Gas around $z=1$ in the IllustrisTNG model](https://arxiv.org/abs/2604.24836)
...
### [12] [Testing template-fitting models for the multipoles of the two-point clustering of galaxy clusters](https://arxiv.org/abs/2604.25762)
...
Recommendation: ★★★★☆ (65/100) - 与 Zotero 兴趣画像中的 euclid 等主题/作者匹配。
...
### [13] [JWST Constraints on Primordial Magnetic Fields](https://arxiv.org/abs/2604.24835)
...
### [14] [Microlensing of fast and slow compact objects](https://arxiv.org/abs/2604.25434)
...
### [15] [Fast radio burst dispersion is an unbiased tracer of matter on large scales](https://arxiv.org/abs/2604.25828)
...
### [16] [Generalizing the CPL Parametrization through Dark Sector Interaction](https://arxiv.org/abs/2604.25373)
...
### [17] [Bound or blown: the fate of hot gas in galaxy groups](https://arxiv.org/abs/2604.24863)
