...
### [1] [Probing power spectrum enhancement at small scales with SKA](https://arxiv.org/abs/2602.24117)
...
### [2] [A New Window into the Baryon Cycle at Cosmic Noon with Line Intensity Mapping: Forecasts for auto- and cross-correlations in [CII]-158$μ$m, HI 21 cm, CO$_{J+1\rightarrow J}$, and H$α$ galaxies](https://arxiv.org/abs/2602.24120)
...
Recommendation: ★★★★☆ (72/100) - 与 Zotero 兴趣画像中的 ska, euclid 等主题/作者匹配。
...
### [3] [Weak lensing higher-order statistics to disentangle modified gravity and massive neutrinos](https://arxiv.org/abs/2602.24154)
...
### [5] [Discovery of a nearby radio relic in the low-mass, merging cluster Abell 4067](https://arxiv.org/abs/2602.24206)
...
### [6] [Dark Acoustic Oscillations and the Hubble Tension](https://arxiv.org/abs/2602.23895)
...
### [7] [Forecasting the cross correlation of Terahertz Intensity Mapper [CII] line intensity maps with Euclid galaxies](https://arxiv.org/abs/2602.24204)
...
### [8] [Filling the Gap in Cluster Evolution: JWST's Glimpse into a Young, Star-Forming Cluster at Cosmic Noon](https://arxiv.org/abs/2602.24162)
...
### [9] [Predicting Resolved Dust Attenuation from Local Galaxy Properties Using MaNGA](https://arxiv.org/abs/2602.23767)
...
### [10] [Single Parameter Model for Galaxy Rotation Curves](https://arxiv.org/abs/2602.24211)
...
### [12] [Ruling out conventional photoionization models in the closest LINER M31 with CFHT/SITELLE observations](https://arxiv.org/abs/2602.23984)
...
### [13] [Constraining the mass of the M31 ionized baryon Halo using CHIME/FRB Catalog 2](https://arxiv.org/abs/2602.23749)
...
### [14] [Zooming in on the circumgalactic medium with GIBLE: Cloud-scale simulations with cosmological initial conditions](https://arxiv.org/abs/2602.23416)
