...
### [1] [The ALMaQUEST Survey XVII: Unveiling Multiple Quenching Pathways in Green Valley Galaxies via Molecular Gas and Quenching Timescale Analyses](https://arxiv.org/abs/2601.09225)
...
### [3] [Polarization echoes from past nuclear activity in the quasi-periodic eruption source GSN 069](https://arxiv.org/abs/2601.08940)
...
### [4] [New Estimate for the Cosmic Ray-Induced $\rm H_2$ Photodissociation Rate in the Interstellar Medium](https://arxiv.org/abs/2601.09387)
...
### [7] [A New Constraint on the Optical Depth from the Reionization History Independent of CMB Large-Scale E-Mode Polarization](https://arxiv.org/abs/2601.09644)
*Yuta Kageura,Masami Ouchi,Fumihiro Naokawa,Hiroya Umeda,Akinori Matsumoto,Yuichi Harikane,Minami Nakane,Tran Thi Thai*

Main category: astro-ph.CO

Recommendation: ★★★★☆ (75/100) - 与 Zotero 兴趣画像中的 polarization, jwst 等主题/作者匹配。
...
### [8] [Collapse versus Disruption: The Fate of Compact Stellar Systems in Ultralight Dark Matter Halos](https://arxiv.org/abs/2601.09403)
...
### [9] [Time delay measurements with Broken Power Law model](https://arxiv.org/abs/2601.09369)
*Guanhua Rui,Bin Hu,Wei Du*

Main category: astro-ph.CO

Recommendation: ★★★☆☆ (58/100) - 与 Zotero 兴趣画像中的 lensing, lens model 等主题/作者匹配。
...
### [10] [Resolving Hubble tension and locating missing baryons: Synergies between fast radio bursts and emerging cosmological probes](https://arxiv.org/abs/2601.09521)
...
### [11] [Owl-z: a Bayesian tool to select z \geq 7 quasars](https://arxiv.org/abs/2601.09332)
