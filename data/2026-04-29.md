...
### [1] [Fast radio burst dispersion is an unbiased tracer of matter on large scales](https://arxiv.org/abs/2604.25828)
...
### [2] [Testing template-fitting models for the multipoles of the two-point clustering of galaxy clusters](https://arxiv.org/abs/2604.25762)
...
### [3] [Microlensing of fast and slow compact objects](https://arxiv.org/abs/2604.25434)
...
### [4] [Generalizing the CPL Parametrization through Dark Sector Interaction](https://arxiv.org/abs/2604.25373)
...
### [5] [JWST Constraints on Primordial Magnetic Fields](https://arxiv.org/abs/2604.24835)
...
### [6] [Bound or blown: the fate of hot gas in galaxy groups](https://arxiv.org/abs/2604.24863)
...
### [7] [Cosmic gas accretion from filaments onto galaxy clusters using the IllustrisTNG simulation](https://arxiv.org/abs/2604.24852)
...
### [8] [Environmental dependence of the Mass-Metallicity Star Formation Relations at z=4-10 with JWST](https://arxiv.org/abs/2604.25632)
...
Recommendation: ★★☆☆☆ (36/100) - 与 Zotero 兴趣画像中的 jwst, alma, euclid 等主题/作者匹配。
...
### [9] [The PHANGS-Hα survey. Ground-based narrow-band imaging of nearby star-forming galaxies](https://arxiv.org/abs/2604.25627)
...
Recommendation: ★★☆☆☆ (34/100) - 与 Zotero 兴趣画像中的 alma, jwst, molecular, molecular gas 等主题/作者匹配。
...
### [10] [Multi-component, axisymmetric dynamical models of dSphs based on distribution functions: inferences on dark matter and intermediate-mass black holes in Draco and Ursa Minor](https://arxiv.org/abs/2604.24855)
...
### [11] [JOYS+ analyses of OCN$^-$, N$_2$O, NO, and complex cyanides in ices -- Thermal processing results in modest enhancement of OCN$^-$ ice](https://arxiv.org/abs/2604.25915)
...
### [12] [From short-lived to long-lived clouds: impact of star formation models on giant molecular cloud evolution in simulations of an NGC 300-like galaxy](https://arxiv.org/abs/2604.25911)
...
### [14] [Galaxy mergers and disk angular momentum evolution: stellar halos as a critical test](https://arxiv.org/abs/2604.24965)
...
### [16] [Spectral Evolution and Transient Broad-Line Features in the Isolated AGN UNAM-KIAS 613](https://arxiv.org/abs/2604.25219)
...
### [18] [The Thermodynamic and Kinematic Evolution of Circumgalactic Gas around $z=1$ in the IllustrisTNG model](https://arxiv.org/abs/2604.24836)
