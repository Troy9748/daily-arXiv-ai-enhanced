...
Recommendation: ★★★★★ (81/100) - 与 Zotero 兴趣画像中的 molecular, molecular gas 等主题/作者匹配。
...
Recommendation: ★★★★☆ (79/100) - 与 Zotero 兴趣画像中的 polarization, dust, molecular 等主题/作者匹配。
...
### [3] [Mass regulates the emerging timescale of young star clusters](https://arxiv.org/abs/2603.09867)
...
### [4] [Recovering the infall mass for Milky Way satellite galaxy Sextans](https://arxiv.org/abs/2603.08940)
...
### [5] [Black Hole Properties of Type-1 Active Galactic Nuclei in the North Ecliptic Pole Wide Field: I. Mid-infrared Sources with Optical Counterparts](https://arxiv.org/abs/2603.09976)
...
### [6] [The role of mass loss in constraining quenching time in dwarf galaxies from AGB and RGB star counts](https://arxiv.org/abs/2603.09879)
...
### [8] [Going Wide and Deep with Roman: The z~6-9 UV luminosity function in a Roman Deep Field](https://arxiv.org/abs/2603.09828)
*Micaela B. Bagley,Steven L. Finkelstein,James Rhoads,Sangeeta Malhotra,L. Y. Aaron Yung,Rachel S. Somerville,Casey Papovich*

Main category: astro-ph.GA

Recommendation: ★★★☆☆ (42/100) - 与 Zotero 兴趣画像中的 jwst 等主题/作者匹配。
...
### [9] [Obscured Star Formation in the Dwarf Galaxy DDO 43? A Comparative UV-IR Analysis](https://arxiv.org/abs/2603.09670)
...
### [12] [Epicyclic Density Variations in the Indus Stellar Stream](https://arxiv.org/abs/2603.09305)
...
### [13] [HI Observations of Giant Low Surface Brightness Galaxies](https://arxiv.org/abs/2603.09207)
...
### [14] [Reliable Tests of Faint-end UV Luminosity Functions in Strong Lensing Fields](https://arxiv.org/abs/2603.09308)
*Jiashuo Zhang*
...
### [15] [Constraints on Neutrino Mass with Void Weak Lensing Effect](https://arxiv.org/abs/2603.09278)
...
### [16] [Probing Physics Beyond the Standard Model through Combined Analyses of Next-Generation Type Ia Supernova, CMB, and BAO Surveys](https://arxiv.org/abs/2603.09973)
...
Recommendation: ★★★★☆ (67/100) - 与 Zotero 兴趣画像中的 lensing, polarization, spt 等主题/作者匹配。
...
### [17] [Dark Matter Recoupling](https://arxiv.org/abs/2603.09969)
...
Recommendation: ★★★☆☆ (58/100) - 与 Zotero 兴趣画像中的 ska, dark matter 等主题/作者匹配。
...
### [19] [Statistical consistency of sign-switching vacuum energy with cosmological observations](https://arxiv.org/abs/2603.09270)
*Sehjal Khandelwal,Abraão J. S. Capistrano,Suresh Kumar*

Main category: astro-ph.CO

Recommendation: ★★★☆☆ (56/100) - 与 Zotero 兴趣画像中的 spt 等主题/作者匹配。
...
### [20] [Exploring the $S_8$ Tension: Insights from the CatNorth 1.5-Million Quasar Candidates](https://arxiv.org/abs/2603.09457)
...
### [21] [Hidden Vela Supercluster Revealed by First Hybrid Redshift & Peculiar Velocity Reconstruction](https://arxiv.org/abs/2603.09339)
...
### [22] [Binary Black Holes population synthesis based on the current LVK observations](https://arxiv.org/abs/2603.08785)
