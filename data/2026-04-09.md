...
### [1] [Multi-scale Gas Structure and Dynamics in an Extragalactic Central Molecular Zone](https://arxiv.org/abs/2604.06354)
...
### [2] [The Galaxy Activity, Torus, and outflow Survey (GATOS) XIII: Coupling Driven H2 Excitation in Seyferts](https://arxiv.org/abs/2604.06524)
...
### [3] [Clues for the accretion regulated dust torus in the changing-look AGN SDSS J101152.98+544206.4](https://arxiv.org/abs/2604.07024)
*Zhang XueGuang*
...
### [4] [Collisional Dynamics of Stars and Dark Matter in Ultra-Faint Galaxies](https://arxiv.org/abs/2604.06304)
...
### [5] [Large Interstellar Polarisation Survey. III. Observational constraints on the structure of grains](https://arxiv.org/abs/2604.06986)
*Ralf Siebenmorgen,Stefano Bagnulo,Lapo Fanciullo,Thomas Vannieuwenhuyse,Vincent Guillet*

Main category: astro-ph.GA

Recommendation: ★★★☆☆ (60/100) - 与 Zotero 兴趣画像中的 dust, polarised 等主题/作者匹配。
...
### [7] [Metal Mayhem at $\rm z \sim 7-10$: Diversity and Evolution of Gas-Phase Metallicity Gradients](https://arxiv.org/abs/2604.07076)
...
### [8] [Extinction Distributions in Nearby Star-resolved Galaxies. II. M33](https://arxiv.org/abs/2604.06983)
...
### [9] [The Evolution of Star-Forming Gas in STARFORGE: From Clouds, to Cores, to Stars](https://arxiv.org/abs/2604.06471)
...
### [10] [Galactic Rotation Curves from Full-Disk Newtonian Gravity: The Lost and Found Model](https://arxiv.org/abs/2604.06917)
...
### [11] [The Illusion of Morphology in Tidal Structures: Changes to Stellar Shells and Streams in Non-Spherical Haloes](https://arxiv.org/abs/2604.06585)
...
### [12] [Phase spirals induced by the gas warp](https://arxiv.org/abs/2604.06862)
...
### [13] [RadioAstron reveals a change in the jet collimation profile of 3C 84](https://arxiv.org/abs/2604.06803)
...
### [14] [Introducing sapphire: Towards Hybrid Physics-Informed, Data-Driven Modeling of Galaxy Formation](https://arxiv.org/abs/2604.06318)
...
### [16] [Joint Curvature and Growth Rate measurements with Supernova Peculiar Velocities and the CMB](https://arxiv.org/abs/2604.06361)
...
### [17] [Primordial magnetic fields in the light of upcoming post-EoR Lyman-$α$ and 21-cm observations](https://arxiv.org/abs/2604.07327)
