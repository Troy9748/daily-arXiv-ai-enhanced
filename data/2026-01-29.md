...
### [1] [Euclid preparation. Galaxy power spectrum modelling in redshift space](https://arxiv.org/abs/2601.20826)
...
Recommendation: ★★★★★ (82/100) - 与 Zotero 兴趣画像中的 euclid, dark matter 等主题/作者匹配。
...
### [2] [SPT-3G D1: A Measurement of Secondary Cosmic Microwave Background Anisotropy Power](https://arxiv.org/abs/2601.20551)
...
### [3] [Replicating weak-lensing summary-statistic covariances with normalizing flows](https://arxiv.org/abs/2601.20669)
...
### [4] [An X-ray-Emitting Proto-Cluster at $z\approx5.7$ Reveals Rapid Structure Growth](https://arxiv.org/abs/2601.19978)
...
### [5] [How well is the local Large Scale Structure of the Universe known? CosmicFlows vs. Biteau's Galaxy Catalog with Cloning](https://arxiv.org/abs/2601.20808)
...
### [6] [Molecular Gas Detections in Eight Faint DSFGs with Red NIR Colors at z = 1.2-2.5](https://arxiv.org/abs/2601.20862)
...
### [7] [Massive dusty multiphase outflow in local merger shows no sign of slowing on kiloparsec scales](https://arxiv.org/abs/2601.20489)
...
### [8] [GLIMPSE-DDT spectroscopic properties of faint-end galaxies at $z\sim6$: Towards first metal enrichment, dust production, and ionizing photon production](https://arxiv.org/abs/2601.20045)
...
Recommendation: ★★★★★ (81/100) - 与 Zotero 兴趣画像中的 dust, jwst, lensing 等主题/作者匹配。
...
### [9] [A GLIMPSE into the UV Continuum Slopes of the Faintest Galaxies in the Epoch of Reionization](https://arxiv.org/abs/2601.19995)
...
Recommendation: ★★★★☆ (77/100) - 与 Zotero 兴趣画像中的 jwst, lensing, dusty, strong lensing 等主题/作者匹配。
...
### [10] [A Quiescent Galaxy in a Gas-Rich Cosmic Web Node at z~3](https://arxiv.org/abs/2601.20473)
...
### [11] [Spatial distribution of organics in the Horsehead nebula: signposts of chemistry driven by atomic carbon](https://arxiv.org/abs/2601.20146)
...
### [12] [Bottom-heavy initial mass functions reveal hidden mass in early galaxies](https://arxiv.org/abs/2601.20864)
...
### [13] [GLIMPSE-D: Metallicity Decline in Faint Galaxies: Implications for [O III]+Hb Luminosity Function and Reionisation Budget](https://arxiv.org/abs/2601.19989)
...
### [14] [Metallicity Structure in Galactic Longitude-Velocity Diagrams of the Milky Way Disk and FIRE-2 Simulations](https://arxiv.org/abs/2601.20278)
...
### [15] [MAJORS II: HCO+& HCN Abundances in W40](https://arxiv.org/abs/2601.19971)
