...
### [1] [Late-time acceleration without a vacuum term in ${f(R,L_m)}$ gravity: scaling deSitter dynamics and parameter constraints](https://arxiv.org/abs/2601.10699)
...
### [2] [Cosmoglobe DR2. VI. Disentangling hot and cold thermal dust emission with Planck HFI](https://arxiv.org/abs/2601.10640)
...
### [3] [Extracting intrinsic alignments in the Dark Energy Survey's year 1 data, using the self-calibration method and LSST-DESC tools](https://arxiv.org/abs/2601.10314)
...
### [4] [Effect of Primordial Black Holes on the global 21-cm signal](https://arxiv.org/abs/2601.10304)
*Atrideb Chatterjee*
...
### [5] [The BINGO project X. Cosmological parameter constraints from HI Intensity Mapping lognormal simulations](https://arxiv.org/abs/2601.10152)
...
### [6] [Breathless BEARS: [O$_{\rm \,III}$] 88$μ$m Emission of Dusty Star-Forming Galaxies at $z = 3-4$](https://arxiv.org/abs/2601.09780)
...
### [7] [Testing the correlation between bending angle and polarization properties of bent radio galaxies](https://arxiv.org/abs/2601.10361)
*S. Vanderwoude,E. Osinga,B. M. Gaensler,J. L. West,R. J. van Weeren*

Main category: astro-ph.GA

Recommendation: ★★☆☆☆ (36/100) - 与 Zotero 兴趣画像中的 polarization, ska, polarized 等主题/作者匹配。
...
### [8] [The X-Ray Dot: Exotic Dust or a Late-Stage Little Red Dot?](https://arxiv.org/abs/2601.09778)
...
### [9] [Euclid preparation. 3D reconstruction of the cosmic web with simulated Euclid Deep spectroscopic samples](https://arxiv.org/abs/2601.10709)
...
### [11] [Active Galactic Nuclei and STaR fOrmation in Nearby Galaxies (AGNSTRONG). II: Results for Jetted Type-I AGNs with Strong Ionized Gas Outflows](https://arxiv.org/abs/2601.10372)
*Chen Qin,Huynh Anh N. Le,Yongquan Xue,Shifu Zhu,Xiaozhi Lin,Kim Ngan Nhat Nguyen*

Main category: astro-ph.GA

Recommendation: ★★☆☆☆ (25/100) - 与 Zotero 兴趣画像中的 dust, submillimeter 等主题/作者匹配。
...
### [14] [Calibrating Mid-Infrared Emission Features As Diagnostics of Star Formation in Infrared-Luminous Galaxies via Radiative Transfer Modeling](https://arxiv.org/abs/2601.09810)
...
### [15] [The influence of magnetic fields in Cloud-Cloud Collisions](https://arxiv.org/abs/2601.09794)
