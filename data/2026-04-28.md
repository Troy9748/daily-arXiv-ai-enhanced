...
Recommendation: ★★☆☆☆ (36/100) - 与 Zotero 兴趣画像中的 molecular, jwst, molecular gas 等主题/作者匹配。
...
Recommendation: ★★☆☆☆ (27/100) - 与 Zotero 兴趣画像中的 csst 等主题/作者匹配。
...
### [3] [Halfway to the Peak: Kinematic Signatures of Stable Rotating Disks in Luminous Infrared Galaxies at z=0.5-0.6](https://arxiv.org/abs/2604.24711)
...
### [4] [Aromatic rings in the Central Molecular Zone: Benzonitrile](https://arxiv.org/abs/2604.24510)
...
### [5] [Machine learning technique for morphological classification of galaxies from SDSS. IV. Visual inspection vs CNN for merging, irregular, edge-on, barred, ringed, and with dust lanes galaxies at 0.02<z<0.1](https://arxiv.org/abs/2604.24471)
...
### [6] [Clash of the Trident and Tuning Fork: insights from bar and spiral strength in the (massive black hole)-stellar mass diagrams, and the `Triangal' galaxy evolution schema](https://arxiv.org/abs/2604.24084)
*Alister W. Graham*

Main category: astro-ph.GA

Recommendation: ★★☆☆☆ (25/100) - 与 Zotero 兴趣画像中的 dust, dusty 等主题/作者匹配。
...
### [7] [A GLIMPSE of the 99%: a census of the faintest galaxies during the epoch reionization and its implications for galaxy formation models](https://arxiv.org/abs/2604.23823)
...
Recommendation: ★★☆☆☆ (25/100) - 与 Zotero 兴趣画像中的 jwst, lensing 等主题/作者匹配。
...
### [8] [Two Exciting High-redshift Galaxy Candidates Turn Out to Be Two Exciting Ultra-cool Brown Dwarfs](https://arxiv.org/abs/2604.23668)
...
### [9] [The Dependence of the Mean Spectral Energy Distributions on the Accretion Rate for Quasars with $z < 0.75$ from the Sloan Digital Sky Survey](https://arxiv.org/abs/2604.23123)
...
### [10] [Analysis of a Septuple Open Cluster System and Its Extended Family in Gaia DR3](https://arxiv.org/abs/2604.23093)
...
### [11] [Itô tracers: continuous-trajectory Lagrangian particles for Eulerian hydrodynamics](https://arxiv.org/abs/2604.23041)
...
### [12] [The abundance and radial distribution of faint and ultra-faint dwarfs in galaxy clusters](https://arxiv.org/abs/2604.22920)
*Pradyumna Sadhu,Laura V. Sales,Julio F. Navarro,Raphaël Errani,Jose Benavides,Eric W. Peng*

Main category: astro-ph.GA

Recommendation: ★★☆☆☆ (25/100) - 与 Zotero 兴趣画像中的 euclid, dark matter 等主题/作者匹配。
...
### [17] [Propagating data-driven galaxy redshift distribution uncertainties in 3$\times$2-pt analyses](https://arxiv.org/abs/2604.24425)
...
### [18] [CLASH-VLT: The Fifth Force in Chameleon Gravity from Joint Lensing and Kinematics Cluster Mass Profiles](https://arxiv.org/abs/2604.23631)
...
### [19] [The open-Universe signal: A model artifact rather than genuine curvature](https://arxiv.org/abs/2604.23492)
*Peng-Ju Wu*
...
### [20] [STVG-MOG Cluster Dynamics and the Cosmological $1/r^2$ Force Law from Pairwise kSZ Data](https://arxiv.org/abs/2604.23440)
*John W. Moffat*
...
### [21] [Testing Scalar Field Dark Matter models in M31 galaxy through the Rotation Curve analysis](https://arxiv.org/abs/2604.23353)
...
### [22] [Cosmological evolution of interacting dark energy with a CPL equation of state](https://arxiv.org/abs/2604.22970)
...
### [23] [The Oort Cloud as a Gravitational Detector for Primordial Black Holes](https://arxiv.org/abs/2604.22961)
*Sohrab Rahvar*
