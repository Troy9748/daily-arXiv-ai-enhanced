...
### [1] [Resolved Maps of Gas and Dust in a Massive Quiescent Galaxy at z=2 from INQUEST-JWST: Evidence of Accretion and Rejuvenation](https://arxiv.org/abs/2604.26195)
...
### [2] [A quantum theory of the alignment and polarization of very small dust grains](https://arxiv.org/abs/2604.26001)
*Boy Lankhaar*
...
### [3] [Dust enrichment from core-collapse supernovae and extinction curves in the high-redshift universe](https://arxiv.org/abs/2604.26750)
*Koki Otaki,Raffaella Schneider,Simone Bianchi,Joris Witstok,Luca Graziani,Marco Limongi,Roberto Maiolino*

Main category: astro-ph.GA

Recommendation: ★★★★☆ (80/100) - 与 Zotero 兴趣画像中的 dust, jwst 等主题/作者匹配。
...
### [7] [Euclid preparation. Refining input galaxy shape distributions for shear calibration simulations](https://arxiv.org/abs/2604.26684)
...
### [9] [Predicted number counts and clustering of Hi galaxies from future radio surveys](https://arxiv.org/abs/2604.26886)
*Ainulnabilah Nasirudin,Philip Bull,Isabelle Ye*

Main category: astro-ph.CO

Recommendation: ★★★★☆ (66/100) - 与 Zotero 兴趣画像中的 ska, dark matter 等主题/作者匹配。
...
### [10] [Tidal Heating of Stellar Clusters in Fuzzy Dark Matter Halos](https://arxiv.org/abs/2604.26393)
*Yiheng Liu,Xinyu Li*
...
### [11] [Sensitivity of binary pulsar timing to spin-0 and spin-1 ultralight dark matter](https://arxiv.org/abs/2604.26092)
...
### [13] [Transient Parity Violation during Inflation: Implications for PTA Gravitational Waves](https://arxiv.org/abs/2604.26513)
...
### [15] [Bayesian power spectrum estimation with modelling of systematic effects in delay-fringe rate space](https://arxiv.org/abs/2604.26885)
...
### [16] [Double-Peaked Ly$α$ Emission during Reionization Requires Nearby Voids and a Favorable Local Ionizing Background](https://arxiv.org/abs/2604.26331)
