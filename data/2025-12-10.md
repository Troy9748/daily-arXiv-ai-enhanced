...
### [1] [Foreground Mitigation for CMB Lensing with the Global Minimum Variance Quadratic Estimator](https://arxiv.org/abs/2512.08908)
*Yuka Nakato,W. L. Kimmy Wu,Ana Carolina Silva Oliveira,Yuuki Omori,Abhishek S. Maniyar*

Main category: astro-ph.CO

Recommendation: ★★☆☆☆ (36/100) - 与 Zotero 兴趣画像中的 lensing, spt, polarization 等主题/作者匹配。
...
### [2] [The frame-dragging vector potential on galaxy scales from DM-only Newtonian $N$-body simulations](https://arxiv.org/abs/2512.08703)
...
### [3] [Isocurvature Induced Gravitational Waves at Pulsar Timing Arrays](https://arxiv.org/abs/2512.08301)
...
### [4] [Probing the Warm Dark Matter mass with [C II] intensity mapping](https://arxiv.org/abs/2512.07933)
...
### [5] [Core-halo scaling relations in self-interacting scalar field dark matter](https://arxiv.org/abs/2512.07020)
...
Recommendation: ★★☆☆☆ (39/100) - 与 Zotero 兴趣画像中的 dust, alma, submillimeter 等主题/作者匹配。
...
### [7] [Tracing Nitrogen Enrichment across Cosmic Time with JWST](https://arxiv.org/abs/2512.07955)
...
### [8] [High-Redshift Galactic Outflows: Orientation Effects, Kinematics, and Metallicity in TNG50 and SERRA](https://arxiv.org/abs/2512.08543)
...
### [9] [Photochemistry of interstellar ice forming Complex Organic Molecules](https://arxiv.org/abs/2512.08413)
...
### [11] [Forecasting Dark Matter Subhalo Constraints from Stellar Streams using Implicit Likelihood Inference](https://arxiv.org/abs/2512.07960)
...
### [13] [On the missing dust of super-early galaxies: Supernova blowout and gas-dust venting in Blue Monsters](https://arxiv.org/abs/2512.07945)
