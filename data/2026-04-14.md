...
### [1] [Reionization Topology as a Probe of Self-Interacting Dark Matter](https://arxiv.org/abs/2604.10726)
*Zihan Wang*
...
### [2] [Impact of Stochastic Pop~III X-ray Binaries on the Cosmological 21-cm Signal](https://arxiv.org/abs/2604.11542)
...
### [4] [The environmental imprint on molecular layering in the dusty streamer of M512](https://arxiv.org/abs/2604.11439)
*M. De Simone,L. Cacciapuoti,D. Capela,E. Macias,L. Podio,A. Miotello,A. Gupta,J. Bae,S. Grant,C. Espaillat*

Main category: astro-ph.GA

Recommendation: ★★★★★ (81/100) - 与 Zotero 兴趣画像中的 dusty, molecular, alma 等主题/作者匹配。
...
### [5] [Full-polarization millimeter wavelength variability of Sagittarius A* during the 2018 EHT campaign](https://arxiv.org/abs/2604.10287)
...
Recommendation: ★★★★★ (81/100) - 与 Zotero 兴趣画像中的 polarization, alma, polarized 等主题/作者匹配。
...
### [6] [Extragalactic microlensing through Ultra Diffuse Galaxies](https://arxiv.org/abs/2604.11368)
*Sung Kei Li,Thomas Broadhurst,Jose M. Diego,Jeremy Lim,Jose M. Palencia,James Nianias*

Main category: astro-ph.GA

Recommendation: ★★★★☆ (80/100) - 与 Zotero 兴趣画像中的 jwst, euclid, lensing, dark matter 等主题/作者匹配。
...
### [7] [A first empirical derivation of the average dust attenuation law at 2<z<7](https://arxiv.org/abs/2604.09763)
...
### [8] [Do little red dots really form a distinct class of astronomical objects?](https://arxiv.org/abs/2604.11677)
...
### [9] [Global m=1 slow mode in near-Keplerian self-gravitating torus: applications to stellar nuclear disks and AGN molecular tori](https://arxiv.org/abs/2604.11528)
...
### [11] [Apparent Stability in Self-Gravitating Turbulence and the Evolution of Molecular Clouds](https://arxiv.org/abs/2604.10699)
*Eric Keto*
...
### [12] [Magnetic field alignment with dense cores in the transition between cloud and core scales](https://arxiv.org/abs/2604.09770)
...
### [13] [A consistent MOND modelling of the Bullet Cluster](https://arxiv.org/abs/2604.10811)
*X. Hernandez*
...
### [14] [Possible Supermassive Dark Object Composed of Light Fermionic Gas with an Embedded Neutron Star Core](https://arxiv.org/abs/2604.10011)
...
### [15] [Starbursts at Cosmic Dawn: Formation of Globular Clusters, Ultra-Faint Dwarfs, and Population III star clusters at z > 6](https://arxiv.org/abs/2604.10119)
*Olof Nebrin*
...
### [16] [Galactic Archaeology with the Subaru `Ōnohi`ula Prime Focus Spectrograph Strategic Program](https://arxiv.org/abs/2604.09875)
...
### [17] [Gas-rich ultra-diffuse galaxies: alleviating the MOND tension with HMG](https://arxiv.org/abs/2604.09652)
*Robert Monjo*
