...
### [1] [A possible pathway to UHZ1-type systems at z~10 by heterogeneous mass primordial black holes as dark matter](https://arxiv.org/abs/2601.08936)
...
### [2] [A New Constraint on the Optical Depth from the Reionization History Independent of CMB Large-Scale E-Mode Polarization](https://arxiv.org/abs/2601.09644)
*Yuta Kageura,Masami Ouchi,Fumihiro Naokawa,Hiroya Umeda,Akinori Matsumoto,Yuichi Harikane,Minami Nakane,Tran Thi Thai*

Main category: astro-ph.CO

Recommendation: ★★☆☆☆ (29/100) - 与 Zotero 兴趣画像中的 polarization, jwst 等主题/作者匹配。
...
### [3] [Resolving Hubble tension and locating missing baryons: Synergies between fast radio bursts and emerging cosmological probes](https://arxiv.org/abs/2601.09521)
...
### [4] [Collapse versus Disruption: The Fate of Compact Stellar Systems in Ultralight Dark Matter Halos](https://arxiv.org/abs/2601.09403)
...
### [5] [Time delay measurements with Broken Power Law model](https://arxiv.org/abs/2601.09369)
*Guanhua Rui,Bin Hu,Wei Du*

Main category: astro-ph.CO

Recommendation: ★★☆☆☆ (25/100) - 与 Zotero 兴趣画像中的 lensing, lens model 等主题/作者匹配。
...
### [6] [Owl-z: a Bayesian tool to select z \geq 7 quasars](https://arxiv.org/abs/2601.09332)
...
### [7] [Bound Dark Energy: Particle Physics model in alignment with recent DESI cosmological measurements](https://arxiv.org/abs/2601.08943)
...
### [8] [The ALMaQUEST Survey XVII: Unveiling Multiple Quenching Pathways in Green Valley Galaxies via Molecular Gas and Quenching Timescale Analyses](https://arxiv.org/abs/2601.09225)
...
### [9] [Digging into the Interior of Hot Cores with ALMA. VI. The Formation of Low-mass Multiple Systems in High-mass Cluster-forming Regions](https://arxiv.org/abs/2601.08904)
...
### [10] [New Estimate for the Cosmic Ray-Induced $\rm H_2$ Photodissociation Rate in the Interstellar Medium](https://arxiv.org/abs/2601.09387)
...
### [11] [Polarization echoes from past nuclear activity in the quasi-periodic eruption source GSN 069](https://arxiv.org/abs/2601.08940)
...
### [12] [Spinning compact object and chaos in galactic centers](https://arxiv.org/abs/2601.08937)
