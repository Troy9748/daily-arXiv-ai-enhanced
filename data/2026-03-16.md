...
### [1] [Euclid preparation. Simulated galaxy catalogues for non-standard cosmological models](https://arxiv.org/abs/2603.13148)
...
### [2] [Robustness of Neural Networks for CMB Polarization Foreground Removal](https://arxiv.org/abs/2603.12364)
*Luca Gomez Bachar,Cora Dvorkin,Alberto Daniel Supanitsky*

Main category: astro-ph.CO

Recommendation: ★★☆☆☆ (29/100) - 与 Zotero 兴趣画像中的 polarization, polarized 等主题/作者匹配。
...
### [3] [Fast Fourier Transform evaluation of the Fresnel integral for gravitational-wave lensing](https://arxiv.org/abs/2603.12333)
...
### [4] [A 2% determination of $N_{\rm eff}$ from primordial element abundance, cosmic microwave background, and baryon acoustic oscillation measurements](https://arxiv.org/abs/2603.13226)
...
### [6] [Exploring Beyond ΛCDM with the Weak Lensing Power Spectrum and Bispectrum](https://arxiv.org/abs/2603.12504)
...
### [7] [Standard Perturbation Theory for Interacting Dark Sector cosmologies I: Breakdown of Einstein de Sitter kernels](https://arxiv.org/abs/2603.12431)
*Matheus Wolney,Gabriel Sampaio,Humberto Borges,Iuri Baranov,Rodrigo von Marttens*

Main category: astro-ph.CO

Recommendation: ★★☆☆☆ (25/100) - 与 Zotero 兴趣画像中的 spt, dark matter 等主题/作者匹配。
...
### [8] [Probing Cosmology through Higher-Order CMB Lensing Statistics](https://arxiv.org/abs/2603.12335)
...
### [9] [Phenomenology of an Open Effective Field Theory of Dark Energy](https://arxiv.org/abs/2603.12321)
...
### [11] [Euclid preparation. Far-infrared predictions for Euclid galaxy catalogues: cluster, protocluster, and field](https://arxiv.org/abs/2603.13195)
...
### [12] [Spectroscopical Confirmation and Lens Modeling of a Complex Strong Lensing System Produced by a Close Galaxy Pair at $z_d=0.79$](https://arxiv.org/abs/2603.12790)
*Zizhao He,Limeng Deng,Qihang Chen,Yiping Shu,Nan Li,Di Wu*

Main category: astro-ph.GA

Recommendation: ★★☆☆☆ (32/100) - 与 Zotero 兴趣画像中的 lensing, strong lensing 等主题/作者匹配。
...
### [15] [Galaxy fly-bys sustain bar-halo friction and bar slowdown in disk galaxies](https://arxiv.org/abs/2603.12584)
...
### [16] [SPHEREx Wide-Field Infrared Spectral Mapping of Interstellar Ices and Polycyclic Aromatic Hydrocarbons](https://arxiv.org/abs/2603.12390)
...
### [17] [Simulating AGN wind feedback with variable feedback efficiencies in idealised disc galaxies](https://arxiv.org/abs/2603.12322)
...
### [18] [Does supernova feedback regulate the star formation rate in dwarf galaxies?](https://arxiv.org/abs/2603.12821)
