...
### [1] [Discovering gravitational waveform distortions from lensing: a deep dive into GW231123](https://arxiv.org/abs/2512.16916)
*Juno C. L. Chan,Jose María Ezquiaga,Rico K. L. Lo,Joey Bowman,Lorena Magaña Zertuche,Luka Vujeva*

Main category: astro-ph.CO

Recommendation: ★★★★☆ (78/100) - 与 Zotero 兴趣画像中的 lensing, dark matter 等主题/作者匹配。
...
### [2] [Clustering redshift distribution calibration of weak lensing surveys using the DESI-DR1 spectroscopic dataset](https://arxiv.org/abs/2512.15963)
...
### [3] [Cosmological Constraints from Full-Scale Clustering and Galaxy-Galaxy Lensing with DESI DR1](https://arxiv.org/abs/2512.15962)
...
### [5] [DESI-DR1 $3 \times 2$-pt analysis: consistent cosmology across weak lensing surveys](https://arxiv.org/abs/2512.15960)
...
### [6] [The AIDA-TNG project: abundance, radial distribution, and clustering properties of halos in alternative dark matter models](https://arxiv.org/abs/2512.15883)
...
### [7] [The AIDA-TNG project: dark matter profiles and concentrations in alternative dark matter models](https://arxiv.org/abs/2512.15869)
...
### [8] [Dark Acoustic Oscillations as an Early-Universe Explanation of the DESI Anomaly](https://arxiv.org/abs/2512.15870)
*Mathias Garny,Florian Niedermann,Martin S. Sloth*

Main category: astro-ph.CO

Recommendation: ★★★☆☆ (58/100) - 与 Zotero 兴趣画像中的 euclid, dark matter 等主题/作者匹配。
...
### [9] [Decoupling perturbations from background in $f(Q)$ gravity: the square-root correction and the alleviation of the $σ_8$ tension](https://arxiv.org/abs/2512.16551)
...
### [11] [The Simons Observatory: forecasted constraints on primordial gravitational waves with the expanded array of Small Aperture Telescopes](https://arxiv.org/abs/2512.15833)
...
### [12] [The AIDA-TNG project: 3D halo shapes](https://arxiv.org/abs/2512.15856)
...
### [13] [Exploring the magnetic field structure of the Milky Way with pulsars in the SKA era](https://arxiv.org/abs/2512.16159)
*Jun Xu,J. L. Han,Weicong Jing,The SKA Pulsar Science Working Group*

Main category: astro-ph.GA

Recommendation: ★★★★★ (82/100) - 与 Zotero 兴趣画像中的 ska, polarization, polarized 等主题/作者匹配。
...
### [14] [The AGN nature of strong CIII emitters in the Early Universe with JWST](https://arxiv.org/abs/2512.16365)
...
### [15] [The dominant role of dark matter halo in quenching central galaxies](https://arxiv.org/abs/2512.16290)
...
### [16] [Unveiling the properties and origin of massive quenched galaxies at $z\ge2$ in the COLIBRE hydrodynamical simulations](https://arxiv.org/abs/2512.16208)
...
### [17] [MAGellanic Outflow and chemistry Survey (MAGOS): Hot cores in the LMC](https://arxiv.org/abs/2512.15983)
...
### [19] [LSTM-MDNz: Estimating Quasar Photometric Redshifts with an LSTM-Augmented Mixture Density Network](https://arxiv.org/abs/2512.16010)
*Jianzhen Chen,Zhijian Luo,Liping Fu,Zhu Chen,Hubing Xiao,Shaohua Zhang,Chenggang Shu*

Main category: astro-ph.GA

Recommendation: ★★★☆☆ (60/100) - 与 Zotero 兴趣画像中的 euclid, csst 等主题/作者匹配。
...
### [20] [A faint M$_{\rm UV} = -14.5$ Lyman continuum leaker in the reionization epoch: unprecedented Ly$α$ properties at z=5.725](https://arxiv.org/abs/2512.16728)
...
### [22] [The Next Generation Fornax Survey (NGFS).VIII. A Support Vector Machine Approach for Disentangling Globular Clusters from other Sources](https://arxiv.org/abs/2512.15895)
...
### [23] [On the Origin of Kinematic Structure in the Young Association Serpens OB2](https://arxiv.org/abs/2512.16708)
...
### [24] [ASKAP discovery of a 30 kpc bipolar outflow from the edge-on disk of the nearby spiral galaxy ESO 130-G012](https://arxiv.org/abs/2512.15991)
...
### [25] [MUSE Analysis of Gas around Galaxies (MAGG) - VII. Emission line galaxies near strong blended Ly$α$ absorption systems at $z\gtrsim3$](https://arxiv.org/abs/2512.16422)
...
### [26] [Gas Accretion from a Neighbouring Galaxy Fuels the Low-luminosity AGN in NGC 4278](https://arxiv.org/abs/2512.16049)
