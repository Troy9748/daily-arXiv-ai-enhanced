...
### [1] [A tight relation between the distribution of globular clusters and dark matter in AS1063](https://arxiv.org/abs/2602.12332)
*J. M. Diego,C. Goolsby,C. J. Conselice,J. M. Palencia*

Main category: astro-ph.GA

Recommendation: ★★☆☆☆ (38/100) - 与 Zotero 兴趣画像中的 dark matter, jwst, lensing, lens model 等主题/作者匹配。
...
### [2] [Upper limit on HF(1-0) absorption in a dusty star-forming galaxy at $z = 6$: Constraints on early fluorine enrichment](https://arxiv.org/abs/2602.12885)
...
Recommendation: ★★☆☆☆ (32/100) - 与 Zotero 兴趣画像中的 dusty, submillimeter, alma 等主题/作者匹配。
...
### [3] [Self-Consistent Direct Method for Chemical Abundances in High-z Galaxies with JWST](https://arxiv.org/abs/2602.13007)
...
### [4] [ALMA Band 9 CO(6--5) Reveals a Warm Ring Structure Associated with the Embedded Protostar in the Cold Dense Core MC 27/L1521F](https://arxiv.org/abs/2602.12661)
...
### [5] [The Structure and Evolution of LRDs: Insights from JWST NIRSpec Medium and High Resolution Spectroscopy at $z\sim4$](https://arxiv.org/abs/2602.12548)
...
### [6] [H$_2$ Ortho-Para Spin Conversion on Inhomogeneous Grain Surfaces. II. impact of the rotational energy difference between adsorbed ortho-H$_2$ and para-H$_2$ and implication to deuterium fractionation chemistry](https://arxiv.org/abs/2602.13122)
...
### [7] [Spatially resolved star-formation histories of local post-starburst galaxies: Starburst and quenching spatial patterns consistent with recent mergers](https://arxiv.org/abs/2602.13114)
...
### [8] [The optical-infrared relation for active galactic nuclei: The role of contaminations](https://arxiv.org/abs/2602.12839)
...
### [9] [Tracking the dynamical, chemical and spectral evolution of molecular cores with PrestaLine: Gorynych](https://arxiv.org/abs/2602.12792)
...
### [10] [Odd Radio Circles Modeled by Shock-Bubble Interactions](https://arxiv.org/abs/2602.12479)
...
### [11] [Cosmological Simulation with Population III Stellar Feedback and Metal Enrichment I: Model Description And Convergence Test](https://arxiv.org/abs/2602.12460)
...
### [12] [Searching for the Shortest-wavelength Aromatic Infrared Bands: No Evidence for the Predicted 1.05 $μ$m Polycyclic Aromatic Hydrocarbon Feature](https://arxiv.org/abs/2602.12331)
...
### [13] [What Suppresses Star Formation in Bulge-Dominated Early-Type Galaxies?](https://arxiv.org/abs/2602.12324)
...
### [15] [A boost in the precision of cluster-mass models: Exploiting the extended surface brightness of the lensed supernova Refsdal host galaxy](https://arxiv.org/abs/2602.12329)
...
### [16] [Constraining Axion-like Particles through Multi-epoch Monitoring of Strong Gravitational Lenses](https://arxiv.org/abs/2602.12863)
