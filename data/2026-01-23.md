...
### [1] [Reanalyzing DESI DR1: 4. Percent-Level Cosmological Constraints from Combined Probes and Robust Evidence for the Normal Neutrino Mass Hierarchy](https://arxiv.org/abs/2601.16165)
...
### [2] [Enhancing Thermal Sunyaev-Zel'dovich Analyses with Digital Twins of the Local Universe](https://arxiv.org/abs/2601.15935)
...
### [3] [Intrinsic alignments in the FLAMINGO simulations with two-point statistics](https://arxiv.org/abs/2601.15851)
...
### [5] [Two Fluid Quantum Bouncing Cosmology I: Theoretical Model](https://arxiv.org/abs/2601.15542)
...
### [6] [Multi-band Reconstruction of Sixteen Gravitational Lens Systems using PISCO data](https://arxiv.org/abs/2601.15585)
...
Recommendation: ★★☆☆☆ (34/100) - 与 Zotero 兴趣画像中的 euclid, csst, lensing, strong lensing 等主题/作者匹配。
...
### [7] [JWST Advanced Deep Extragalactic Survey (JADES) Data Release 5: MIRI Coordinated Parallels in GOODS-S and GOODS-N](https://arxiv.org/abs/2601.15955)
...
Recommendation: ★★☆☆☆ (32/100) - 与 Zotero 兴趣画像中的 jwst, dusty 等主题/作者匹配。
...
### [8] [Hierarchical bayesian inference: constraining population distribution of dark matter halo shapes via stellar streams](https://arxiv.org/abs/2601.15373)
*David Chemaly,Elisabeth Sola,Vasily Belokurov,Sergey Kosposov,GyuChul Meyong,HanYuan Zhang,Denis Erkal*

Main category: astro-ph.GA

Recommendation: ★★☆☆☆ (30/100) - 与 Zotero 兴趣画像中的 dark matter, euclid 等主题/作者匹配。
...
### [9] [JWST Advanced Deep Extragalactic Survey (JADES) Data Release 5: Catalogs of inferred morphological properties of galaxies from JWST/NIRCam imaging in GOODS-N and GOODS-S](https://arxiv.org/abs/2601.15957)
...
### [10] [JWST Advanced Deep Extragalactic Survey (JADES) Data Release 5: Photometric Catalog](https://arxiv.org/abs/2601.15956)
...
### [11] [JWST Advanced Deep Extragalactic Survey (JADES) Data Release 5: NIRCam Imaging in GOODS-S and GOODS-N](https://arxiv.org/abs/2601.15954)
...
### [12] [Spatially resolved stellar-to-total dynamical mass relation: Radial variations, gradients and profiles of galaxy stellar populations](https://arxiv.org/abs/2601.16019)
*L. Scholz-Diaz,A. R. Gallazzi,S. Zibetti,D. Mattolini*

Main category: astro-ph.GA

Recommendation: ★★☆☆☆ (25/100) - 与 Zotero 兴趣画像中的 dust, dark matter 等主题/作者匹配。
...
### [13] [A multi-wavelength approach of AGN feedback in LINERs: The case of NGC 4438](https://arxiv.org/abs/2601.15991)
*M. Puig-Subirà,J. Moldón,I. Márquez,J. Masegosa,O. González-Martín,L. Hermosa Muñoz,S. Cazzoli,D. Williams-Baldwin*

Main category: astro-ph.GA

Recommendation: ★★☆☆☆ (25/100) - 与 Zotero 兴趣画像中的 interferometer 等主题/作者匹配。
...
### [14] [Clump-like Structures in High-Redshift Galaxies: Mass Scaling and Radial Trends from JADES](https://arxiv.org/abs/2601.15965)
...
### [16] [JADES: A Prominent Galaxy Overdensity Candidate within the First 500 Myr](https://arxiv.org/abs/2601.15960)
...
### [17] [JWST Advanced Deep Extragalactic Survey (JADES) Data Release 5: Photometrically Selected Galaxy Candidates at z > 8](https://arxiv.org/abs/2601.15959)
...
### [18] [Deuteration of HC3N and CH3CCH in the pre-stellar core L1544](https://arxiv.org/abs/2601.15791)
...
### [19] [An Analysis of AGN Feedback in the Compact Galaxy Group Stephan's Quintet](https://arxiv.org/abs/2601.15384)
...
### [20] [A Stratification in Magnetic Field Structures: The Radio Outflow in NGC 4151](https://arxiv.org/abs/2601.15382)
*Salmoli Ghosh,P. Kharb,E. Costantini,J. Gallimore,D. Williams-Baldwin,M. Mehdipour*

Main category: astro-ph.GA

Recommendation: ★★☆☆☆ (25/100) - 与 Zotero 兴趣画像中的 polarization, polarized 等主题/作者匹配。
...
### [21] [What factors shape the radio luminosity of star-forming galaxies? A new calibration from LoTSS-DR2](https://arxiv.org/abs/2601.15374)
...
### [22] [Cis--Trans Rotational Isomerism of Seleno-, Thio-, and Formic Acids and Their Dimers: Chemical Kinetics under Interstellar Conditions](https://arxiv.org/abs/2601.16115)
